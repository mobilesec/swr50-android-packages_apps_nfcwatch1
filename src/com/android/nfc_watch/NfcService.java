...
public class NfcService implements DeviceHostListener {
    static final boolean DBG = true; //false;
    static final String TAG = "NfcService";

    public static final String SERVICE_NAME = "nfc_watch";

    public static final String PREF = "NfcWatchServicePrefs";
    ...
    static final int MSG_SCREEN_OFF_POLLING_TIMEOUT = 12;
    ...
    // Timeout to keep polling after screen turned off
    private static final int SCREEN_OFF_POLLING_TIMEOUT_MS = 25000;
    ...
    public NfcService(Application nfcApplication) {
        ...
        mNfcDispatcher = new NfcDispatcher(mContext, null, false);
        mP2pLinkManager = new P2pLinkManager(mContext, null,
    ...
    void applyScreenOffTimeoutRouting() {
        synchronized (this) {
            if (mScreenState == ScreenStateHelper.SCREEN_STATE_OFF) {
                mScreenState = ScreenStateHelper.SCREEN_STATE_OFF_FINAL;
            }
            applyRouting(false);
        }
    }
    ...
    void applyRouting(boolean force) {
        synchronized (this) {
            ...
            Log.d(TAG, "applyRouting: force = " + force + ", screen = " + ScreenStateHelper.screenStateToString(mScreenState));
    ...
    private NfcDiscoveryParameters computeDiscoveryParameters(int screenState) {
        ...
        if (mIsHceCapable && mScreenState >= ScreenStateHelper.SCREEN_STATE_OFF_FINAL) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_RESUME_POLLING:
                    ...
                    break;
                case MSG_SCREEN_OFF_POLLING_TIMEOUT:
                    applyScreenOffTimeoutRouting();
                    break;
                default:
    ...
    class ApplyRoutingTask extends AsyncTask<Integer, Void, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            synchronized (NfcService.this) {
                ...
                if (mScreenState == ScreenStateHelper.SCREEN_STATE_OFF) {
                    mHandler.sendMessageDelayed(mHandler.obtainMessage(MSG_SCREEN_OFF_POLLING_TIMEOUT),
                        SCREEN_OFF_POLLING_TIMEOUT_MS);
                }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_SCREEN_ON)
                ...
                int userId = 0; //intent.getIntExtra(Intent.EXTRA_USER_HANDLE, 0);
                synchronized (this) {
                    mUserId = userId;
                }
