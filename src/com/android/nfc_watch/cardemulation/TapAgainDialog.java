...
public class TapAgainDialog extends AlertActivity implements DialogInterface.OnClickListener {
    public static final String ACTION_CLOSE = "com.android.nfc_watch.cardmeulation.close_tap_dialog";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ap.mTitle = "";
        ap.mView = getLayoutInflater().inflate(com.android.nfc_watch.R.layout.tapagain, null);

        PackageManager pm = getPackageManager();
        TextView tv = (TextView) ap.mView.findViewById(com.android.nfc_watch.R.id.textview);
        ...
        if (CardEmulation.CATEGORY_PAYMENT.equals(category)) {
            String formatString = getString(com.android.nfc_watch.R.string.tap_again_to_pay);
            tv.setText(String.format(formatString, description));
        } else {
            String formatString = getString(com.android.nfc_watch.R.string.tap_again_to_complete);
            tv.setText(String.format(formatString, description));
        }
